...
function Counter(){
  ...
  return ( // html 태그 코드는 return 안에 작성해줌
    <div>
      ...
      <button onClick={decreament}>감소시키는 버튼</button>
      <button onClick={multiply}>곱하기 버튼</button>
      <button onClick={divide}>나누기 버튼</button>
      <button onClick={zero}>초기화 버튼</button>
